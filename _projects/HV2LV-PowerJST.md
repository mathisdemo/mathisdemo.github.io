...
github: https://github.com/mpek29/HV2LV-PowerJST
...
|-----------|-----------|-----------|
| {% include image.html path="assets/img/projects/HV2LV-PowerJST/schematic.png" width="100%" %} | {% include image.html path="assets/img/projects/HV2LV-PowerJST/pcb_layout.png" width="100%" %} | {% include image.html path="assets/img/projects/HV2LV-PowerJST/3d.png" width="100%" %} |
